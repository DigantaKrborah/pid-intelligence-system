...
async def get_frontend_graph(
    ...
    return _graph.get_frontend_format(unit_name, include_cross_unit=include_cross_unit)
...
async def get_impact_analysis(
    ...
    result = _graph.get_impact_analysis(unit_name, tag, depth)
    if not result["found"]:
...
async def get_by_type(unit_name: str, tag_type: str):
    ...
    items = _graph.get_nodes_by_type(unit_name, tag_type)
...
async def get_cross_unit_graph():
    ...
    return _graph.get_cross_unit_graph_data()
...
async def get_all_units_graph():
    ...
    return _graph.get_all_units_combined()
...
async def add_cross_unit_connection(payload: CrossUnitConnectionRequest):
    ...
    _graph.add_cross_unit_connection(
